          ...
          <form className="space-y-2">
            <div className="flex flex-wrap border border-gray-300">
              <div className="flex-1 min-w-[50%] p-1 border-r border-b border-gray-300">
                ...
                <input type="text" id="name" className="w-full p-0 text-sm border-none" required />
              </div>
              <div className="flex-1 min-w-[50%] p-1 border-b border-gray-300">
                ...
                <input type="date" id="date-filed" className="w-full p-0 text-sm border-none" required />
              </div>
              <div className="flex-1 min-w-[50%] p-1 border-r border-gray-300">
                ...
                <input type="text" id="position" className="w-full p-0 text-sm border-none" required />
              </div>
              <div className="flex-1 min-w-[50%] p-1">
                <label htmlFor="department" className="block text-xs font-bold">DEPARTMENT:</label>
                <input type="text" id="department" className="w-full p-0 text-sm border-none" required />
              </div>
            </div>
            ...
            <div className="flex flex-wrap border border-gray-300">
              <div className="flex-1 min-w-[33%] p-1 border-r border-gray-300">
                ...
                <input type="text" id="inclusive-dates" className="w-full p-0 text-sm border-none" required />
              </div>
              <div className="flex-1 min-w-[33%] p-1 border-r border-gray-300">
                <label htmlFor="to-date" className="block text-xs font-bold">TO:</label>
                <input type="text" id="to-date" className="w-full p-0 text-sm border-none" required />
              </div>
              <div className="flex-1 min-w-[33%] p-1">
                ...
                <input type="number" id="days-requested" className="w-full p-0 text-sm border-none" required />
              </div>
            </div>

            <div className="p-1 border border-gray-300">
              <label htmlFor="reason" className="block text-xs font-bold">REASON:</label>
              <input type="text" id="reason" className="w-full p-0 text-sm border-none" required />
            </div>

            <div className="p-1 border border-gray-300">
              <label htmlFor="person-to-takeover" className="block text-xs font-bold">PERSON TO HAND OVER THE TASK:</label>
              <input type="text" id="person-to-takeover" className="w-full p-0 text-sm border-none" required />
            </div>

            <div className="flex flex-wrap border border-gray-300">
              <div className="flex-1 min-w-[33%] p-1 border-r border-gray-300">
                <label className="block text-xs font-bold">Requested by:</label>
                <input type="text" className="w-full p-0 text-sm border-none" />
              </div>
              <div className="flex-1 min-w-[33%] p-1 border-r border-gray-300">
            ...
            <div className="flex flex-wrap border border-gray-300">
              <div className="flex-1 min-w-[33%] p-1 border-r border-gray-300">
                ...
                <input type="date" className="w-full p-0 text-sm border-none" />
              </div>
              <div className="flex-1 min-w-[33%] p-1 border-r border-gray-300">
              ...
              <div className="flex flex-wrap p-2">
                <div className="flex-1 min-w-[50%]">
                  ...
                  {['Vacation Leave', 'Sick Leave', 'Emergency Leave', 'Maternity Leave', 'Paternity Leave', 'Solo Parent Act/Leave', 'Others:'].map((type) => (
                    <div key={type} className="flex items-center">
                      <input type="checkbox" id={type.replace(/\s+/g, '-').toLowerCase()} className="mr-1" />
                ...
                <div className="flex-1 min-w-[50%]">
                  <div className="flex items-center mb-1">
                    <input type="checkbox" id="with-pay" className="mr-1" />
                    <label htmlFor="with-pay" className="text-xs">With Pay</label>
                  </div>
                  <div className="flex items-center mb-1">
                    <input type="checkbox" id="without-pay" className="mr-1" />
            ...
            <div className="flex flex-wrap border border-gray-300">
              <div className="flex-1 min-w-[50%] p-1 border-r border-gray-300">
                ...
                <input type="text" id="supporting-document" placeholder="Please specify" className="w-full p-0 text-sm border-none" />
              </div>
              <div className="flex-1 min-w-[50%] p-1">
            ...
            <div className="flex items-center justify-between p-1 space-x-4 border border-gray-300">
              ...
              <div className="flex items-center">
                <input type="checkbox" id="employee-copy" className="mr-1" />
                <label htmlFor="employee-copy" className="text-xs">Employee</label>
              </div>
              <div className="flex items-center">
                <input type="checkbox" id="201-file" className="mr-1" />
